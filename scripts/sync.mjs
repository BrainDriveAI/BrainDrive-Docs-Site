  ...
  for (let i=0; i<parts.length; i++){
    ...
    if (repoName === 'BrainDrive-Core') {
      ...
      s = s
        ...
        .replace(/https?:\/\/docs\.braindrive\.ai\/core\/PLUGIN_DEVELOPER_QUICKSTART/gi, 'https://docs.braindrive.ai/core/plugin-development/quickstart')
        .replace(/\]\((?:\.\/)?DEVELOPER_QUICK_START\)/gi, '](https://github.com/BrainDriveAI/BrainDrive-Core/blob/main/docs/plugin-development/quickstart.md)')
        .replace(/\]\((?:\.\/)?DOCUMENTATION_INDEX\)/gi, '](https://github.com/BrainDriveAI/BrainDrive-Core/blob/main/DOCUMENTATION_INDEX.md)')
        .replace(/\/core\/PLUGIN_DEVELOPER_QUICKSTART/gi, '/core/plugin-development/quickstart')
        .replace(/\.\.\/INSTALL\.md/gi, './getting-started/install.md')
        .replace(/\(\/docs\/getting-started\/install\.md\)/gi, '(/core/getting-started/install)')
        .replace(/\(\/docs\/plugin-development\/quickstart\.md\)/gi, '(/core/plugin-development/quickstart)')
