...
title: README
sidebar_position: 1
custom_edit_url: https://github.com/DJJones66/BrainDriveSettings/edit/main/README.md
---

# BrainDrive Settings Plugin

[![Version](https://img.shields.io/badge/version-1.0.0-blue.svg)](https://github.com/DJJones66/BrainDriveSettings)
[![License](https://img.shields.io/badge/License-MIT%20License-green.svg)](https://github.com/DJJones66/BrainDriveSettings/blob/main/LICENSE)
[![BrainDrive](https://img.shields.io/badge/BrainDrive-Plugin-purple.svg)](https://github.com/BrainDrive/BrainDrive)

A comprehensive settings management plugin for BrainDrive that provides essential configuration capabilities including theme management, general settings, and Ollama server configuration.
...
The plugin integrates deeply with BrainDrive's settings system:

- Registers settings definitions automatically during installation
- Uses BrainDrive's Settings Bridge for state management
- Provides service hooks for accessing/setting configuration values
- Includes default settings schemas for rapid onboarding

## 🔧 Configuration

### Settings Schema

The plugin defines comprehensive settings schemas:
...
- **Plugin Documentation:** [BrainDrive Plugin Development Guide](https://docs.braindrive.ai/plugins/how-to/)
- **Issue Tracker:** [GitHub Issues](https://github.com/DJJones66/BrainDriveSettings/issues)

## 📞 Support

- **Documentation:** Check the [BrainDrive Plugin Documentation](https://docs.braindrive.ai/plugins/how-to/)
